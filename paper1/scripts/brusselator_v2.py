...
result_sim = simulate_reactions(
    ...
    cstr_dilution_rate=0.05,  # Lower dilution to preserve oscillation
    cstr_feed_concentrations={'A': 1.0, 'B': 3.5},  # Higher B for stronger instability
)
...
ax.set_title('Brusselator Oscillatory Dynamics')
ax.legend()
plt.tight_layout()
plt.savefig('brusselator_oscillation_v2.png', dpi=150)
plt.close()
print("Saved brusselator_oscillation_v2.png")